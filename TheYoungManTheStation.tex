...
\fancyhead{}\fancyfoot{}
\makeatletter
\fancyhead[LE]{ \footnotesize\sffamily\upshape \@author}
\fancyhead[RO]{ \footnotesize\sffamily\upshape \@title}
\makeatother
...
\renewenvironment{abstract}{
   ...
   \textsuperscript{1}ICFO -- The Institute of Photonic Sciences
   \par
...
Here's an equation with a label, \eqref{first-equation}, and one further down is \eqref{K-r}. So, we have
\begin{equation}
